...
Writer and photographer in İstanbul. The books appear first as electronic editions —
each with its own companion reading site, where the full text is read in the browser.
...
- **[Utopia Without Us](https://hulkiokantabak.github.io/utopia-without-us/)** — a novella; humanity translates itself out of the body, and the Earth heals, unwitnessed.
- **[Vera / Віра](https://hulkiokantabak.github.io/vera/)** — a literary novel.
- **[Visiting Hours / Ziyaret Saatleri](https://hulkiokantabak.github.io/visiting-hours/)** — sixty linked stories in one unnamed city, with a City Guide of a hundred and eighty diagrams (English & Turkish).
